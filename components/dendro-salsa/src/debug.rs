...
pub trait DebugWithDb<Db: ?Sized> {
    ...
    ///     - for [#\[salsa::input\]](dendro_salsa_macros::input) no fields
    ///     - for [#\[salsa::tracked\]](dendro_salsa_macros::tracked) only fields with `#[id]` attribute
    ///     - for [#\[salsa::interned\]](dendro_salsa_macros::interned) any field
